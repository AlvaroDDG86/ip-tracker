...
export default function Search(props) {
  ...
  function searchHandler() {
    ...
    if (valueSearch.current.value === '' || validId.test(valueSearch.current.value)) {
      props.onSearch(valueSearch.current.value);
      valueSearch.current.value = "";
    } else {
      props.onSearchError('The IP is not valid');
    }
  }
  ...
  return (
    <div className="flex">
      ...
      />
      <button
        className="bg-white flex items-center rounded-tr-md rounded-br-md p-2"
